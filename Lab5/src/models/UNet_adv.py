...
class UNet_adv(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNet_adv, self).__init__()
    ...
    def forward(self, x):
        ...
        x1_d2 = self.inc_d2(x)
        x2_d2 = self.down1_d2(x1_d1)
        x3_d2 = self.down2_d2(x2_d1)
        x4_d2 = self.down3_d2(x3_d1)
        x5_d2 = self.down4_d2(x4_d1)
