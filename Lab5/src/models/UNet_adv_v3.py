...
class UNet_adv_v3(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNet_adv_v3, self).__init__()
    ...
    def forward(self, x):
        ...
        x1 = self.up1(x5_d1, x4_d1)
        x1 = self.up2(x1, x3_d1)
        x1 = self.up3(x1, x2_d1)
        x1 = self.up4(x1, x1_d1)

        x2 = self.up1(x5_d1, x4_d1)
        x2 = self.up2(x2, x3_d1)
        x2 = self.up3(x2, x2_d1)
        x2 = self.up4(x2, x1_d1)
