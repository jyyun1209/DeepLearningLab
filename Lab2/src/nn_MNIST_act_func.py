...
# 가장 Accuracy가 높은 버전으로 Acitvation function만 다르게 구현
...
def plot_all(nb_epochs, model1_cost_list, model1_accuracy_list, model2_cost_list, model2_accuracy_list, model3_cost_list, model3_accuracy_list):
    ...
    ax1.set_xlabel('epochs')
    ax1.set_title('Costs for epochs')
    ax1.plot(np.arange(1, nb_epochs + 1, 1), model1_cost_list, 'r', label='Sigmoid')
    ax1.plot(np.arange(1, nb_epochs + 1, 1), model2_cost_list, 'g', label='ReLU')
    ax1.plot(np.arange(1, nb_epochs + 1, 1), model3_cost_list, 'b', label='Tanh')
    ax1.legend()
    ...
    ax2.set_xlabel('epochs')
    ax2.set_title('Accuracies for epochs')
    ax2.plot(np.arange(1, nb_epochs + 1, 1), model1_accuracy_list, 'r', label='Sigmoid')
    ax2.plot(np.arange(1, nb_epochs + 1, 1), model2_accuracy_list, 'g', label='ReLU')
    ax2.plot(np.arange(1, nb_epochs + 1, 1), model3_accuracy_list, 'b', label='Tanh')
    ax2.legend()
